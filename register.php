...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check->num_rows == 0) {
        $conn->query("INSERT INTO users (name, mobile, password) VALUES ('$name', '$mobile', '$password')");
        echo "<div class='alert alert-success text-center'>Registration successful. <a href='login.php'>Login Now</a></div>";
    } else {
        echo "<div class='alert alert-danger text-center'>Mobile already registered.</div>";
    }
}
?>
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-none d-md-block left-side">
            <div class="left-overlay">
                <div>
                    <h1>Join Us!</h1>
                    <p class="mt-3">Create an account to book tickets for amazing events.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 form-container">
            <div class="login-form mx-auto">
                ...
                <form method="post">
                    ...
                    Already have a acount <a href="login.php" class="text-primary">Login here</a>
                </p>
                </form>
            </div>
        </div>
